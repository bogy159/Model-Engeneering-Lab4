...
public class HTMLGenerator implements IGenerator {
  ...
  protected CharSequence _generateHtml(final RoverSystem roverSystem) {
    CharSequence _xblockexpression = null;
    {
      ...
      _builder.append(HTMLGenerator.FILENAME);
  ...
  public static void main(final String[] args) {
    try {
      ...
      final Resource systemResource = resourceSet.getResource(URI.createURI("RoverSystem.xmi"), true);
      final Function1<EObject, Boolean> _function = (EObject o) -> {
        return Boolean.valueOf((o instanceof RoverSystem));
      };
      EObject _findFirst = IterableExtensions.<EObject>findFirst(systemResource.getContents(), _function);
      final RoverSystem system = ((RoverSystem) _findFirst);
      final HTMLGenerator generator = new HTMLGenerator();
      final CharSequence html = generator.generateHtml(system);
      final CharSequence js = generator.generateJavascript(system);
      StringConcatenation _builder = new StringConcatenation();
      _builder.append(HTMLGenerator.FILENAME);
      _builder.append(".html");
      final FileOutputStream fos1 = new FileOutputStream(_builder.toString());
      fos1.write(html.toString().getBytes());
      fos1.close();
      StringConcatenation _builder_1 = new StringConcatenation();
      _builder_1.append(HTMLGenerator.FILENAME);
      _builder_1.append(".js");
      final FileOutputStream fos2 = new FileOutputStream(_builder_1.toString());
      fos2.write(js.toString().getBytes());
      fos2.close();
    } catch (Throwable _e) {
