 ...
 * </p>
 * <ul>
 *   <li>{@link at.ac.tuwien.big.roverml.impl.RepeatImpl#getCommands <em>Commands</em>}</li>
 *   <li>{@link at.ac.tuwien.big.roverml.impl.RepeatImpl#getTransitions <em>Transitions</em>}</li>
 *   <li>{@link at.ac.tuwien.big.roverml.impl.RepeatImpl#getCount <em>Count</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RepeatImpl extends CommandImpl implements Repeat {
	...
	public EList<Transition> getTransitions() {
		if (transitions == null) {
			transitions = new EObjectContainmentEList<Transition>(Transition.class, this, RoverMLPackage.REPEAT__TRANSITIONS);
		}
		return transitions;
	}
	...
	public void setCount(int newCount) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RoverMLPackage.REPEAT__COUNT, oldCount, count));
	}
	 ...
	 * @generated
	 */
	public boolean repeatAtLeastOnce(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		/**
		 *
		...
		final /*@NonInvalid*/ IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(executor, RoverMLTables.STR_Repeat_c_c_repeatAtLeastOnce);
		...
		if (le) {
			...
			final /*@NonInvalid*/ int count_0 = this.getCount();
			final /*@NonInvalid*/ IntegerValue BOXED_count_0 = ValueUtil.integerValueOf(count_0);
			final /*@NonInvalid*/ boolean gt = OclComparableGreaterThanOperation.INSTANCE.evaluate(executor, BOXED_count_0, RoverMLTables.INT_0).booleanValue();
			...
			if (gt) {
				...
				final /*@NonInvalid*/ boolean eq = BOXED_count_0.equals(diff);
				result = eq;
			}
			final /*@NonInvalid*/ boolean logDiagnostic = CGStringLogDiagnosticOperation.INSTANCE.evaluate(executor, TypeId.BOOLEAN, RoverMLTables.STR_Repeat_c_c_repeatAtLeastOnce, this, (Object)null, diagnostics, context, (Object)null, severity_0, result, RoverMLTables.INT_0).booleanValue();
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case RoverMLPackage.REPEAT__TRANSITIONS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case RoverMLPackage.REPEAT__COUNT:
				return getCount();
		}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == Block.class) {
			switch (derivedFeatureID) {
				case RoverMLPackage.REPEAT__COMMANDS: return RoverMLPackage.BLOCK__COMMANDS;
				case RoverMLPackage.REPEAT__TRANSITIONS: return RoverMLPackage.BLOCK__TRANSITIONS;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == Block.class) {
			switch (baseFeatureID) {
				case RoverMLPackage.BLOCK__COMMANDS: return RoverMLPackage.REPEAT__COMMANDS;
				case RoverMLPackage.BLOCK__TRANSITIONS: return RoverMLPackage.REPEAT__TRANSITIONS;
				default: return -1;
			}
		}
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		if (baseClass == Block.class) {
			switch (baseOperationID) {
				case RoverMLPackage.BLOCK___ONLY_TERMINATE_ONCE__DIAGNOSTICCHAIN_MAP: return RoverMLPackage.REPEAT___ONLY_TERMINATE_ONCE__DIAGNOSTICCHAIN_MAP;
				case RoverMLPackage.BLOCK___AT_LEAST_ONE_INCOMING_TRANSITION__DIAGNOSTICCHAIN_MAP: return RoverMLPackage.REPEAT___AT_LEAST_ONE_INCOMING_TRANSITION__DIAGNOSTICCHAIN_MAP;
				default: return -1;
			}
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case RoverMLPackage.REPEAT___REPEAT_AT_LEAST_ONCE__DIAGNOSTICCHAIN_MAP:
				return repeatAtLeastOnce((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
			case RoverMLPackage.REPEAT___ONLY_TERMINATE_ONCE__DIAGNOSTICCHAIN_MAP:
				return onlyTerminateOnce((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
			case RoverMLPackage.REPEAT___AT_LEAST_ONE_INCOMING_TRANSITION__DIAGNOSTICCHAIN_MAP:
