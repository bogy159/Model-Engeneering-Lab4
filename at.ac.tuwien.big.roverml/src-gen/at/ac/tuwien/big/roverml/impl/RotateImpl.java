 ...
 * </p>
 * <ul>
 *   <li>{@link at.ac.tuwien.big.roverml.impl.RotateImpl#getAngle <em>Angle</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RotateImpl extends CommandImpl implements Rotate {
	...
	public NotificationChain basicSetAngle(Angle newAngle, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, RoverMLPackage.ROTATE__ANGLE, oldAngle, newAngle);
	...
	public void setAngle(Angle newAngle) {
		if (newAngle != angle) {
			...
			if (angle != null)
				msgs = ((InternalEObject)angle).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - RoverMLPackage.ROTATE__ANGLE, null, msgs);
			if (newAngle != null)
				msgs = ((InternalEObject)newAngle).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - RoverMLPackage.ROTATE__ANGLE, null, msgs);
			msgs = basicSetAngle(newAngle, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RoverMLPackage.ROTATE__ANGLE, newAngle, newAngle));
	}
